...
func NewAppModule(cdc codec.Codec, keeper keeper.Keeper, ak sdkslashingtypes.AccountKeeper, bk sdkslashingtypes.BankKeeper, sk sdkstakingkeeper.Keeper) AppModule {
	return AppModule{
